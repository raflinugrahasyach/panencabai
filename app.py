...
if 'data_malang' not in st.session_state:
    ...
    st.session_state.data_malang[2018] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [1345, 1337, 1440, 1443, 1836, 1729, 1475, 1224, 1235, 1226, 626, 418],  # In thousands
        'Y': [54680, 61003, 66760, 56227, 64898, 72915, 61818, 50128, 51703, 71415, 24970, 19797]  # In thousands
    })
    ...
    st.session_state.data_malang[2019] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [735, 1341, 1631, 1696, 1718, 1720, 1737, 1271, 641, 1205, 969, 845],  # In thousands
        'Y': [17225, 44331, 59105, 74422, 68398, 80848, 94669, 71294, 43928, 74590, 33657, 31433]  # In thousands
    })
    ...
    st.session_state.data_malang[2020] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [813, 891, 1410, 1518, 1685, 694, 1639, 1337, 869, 1011, 224, 275],  # In thousands
        'Y': [55438, 34461, 73339, 109417, 127267, 47328, 90489, 66846, 66953, 78647, 14665, 14473]  # In thousands
    })
    ...
    st.session_state.data_malang[2021] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [589, 496, 1119, 857, 682, 837, 1609, 732, 1421, 754, 723, 817],  # In thousands
        'Y': [46804, 40857, 91761, 70551, 55821, 68567, 123734, 56399, 116502, 59524, 58080, 48025]  # In thousands
    })
    ...
    st.session_state.data_malang[2022] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [785, 1156, 768, 1800, 1782.50, 1617.50, 1263, 1342.50, 1003.40, 964.75, 1243.65, 1046.10],  # In thousands
        'Y': [140155, 77812, 48133, 93932, 92549, 93874, 71467, 76721, 48753.80, 45802.50, 64340, 20798]  # In thousands
    })
...
if 'data_lumajang' not in st.session_state:
    ...
    st.session_state.data_lumajang[2018] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [69, 37, 49, 43, 16, 25, 15, 21, 51, 55, 104, 826],  # In thousands
        'Y': [3814.40, 6878.00, 6758.00, 4890.00, 3800.00, 11650.00, 21790.00, 28400.00, 27836.00, 36910.00, 31050.00, 21365.00]  # In thousands
    })
    ...
    st.session_state.data_lumajang[2019] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [9, 83, 74, 11, 19, 15, 7, 13, 14, 240, 108, 13],  # In thousands
        'Y': [3616.00, 8279.00, 6967.80, 5174.00, 3653.00, 19730.50, 19048.43, 13467.80, 15129.00, 28488.00, 25209.00, 13714.00]  # In thousands
    })
    ...
    st.session_state.data_lumajang[2020] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [351, 278, 25, 13, 21, 12, 13, 9, 20, 236, 17, 1405],  # In thousands
        'Y': [16008, 8880, 3105, 2690, 2456, 5085, 9470, 29231, 32002, 37643, 40349, 24650]  # In thousands
    })
    ...
    st.session_state.data_lumajang[2021] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [573, 3, 9, 27, 15, 8, 31, 20, 229, 24, 647, 437],  # In thousands
        'Y': [4649, 1870, 2028, 3070, 2479, 2294, 3956, 23625, 21829, 8921, 20837.80, 30741.70]  # In thousands
    })
    ...
    st.session_state.data_lumajang[2022] = pd.DataFrame({
        ...
        'X3(LUAS PANEN)': [20, 23, 26, 44, 23, 8, 7, 29, 251, 8, 15, 288],  # In thousands
        'Y': [3336, 3537, 5115, 4952.10, 4167, 3992, 16831, 17072, 15251.75, 9992, 7959, 8140.80]  # In thousands
    })
